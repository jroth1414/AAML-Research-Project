...
(from scratch)      (ImageNet vs scratch)    (MiT encoder)    (SAM / DINOv3)
   |                         |                    |                 |
...
\begin{itemize}
  ...
  \item Compare CNN (U-Net, DeepLabV3+) vs.\ transformer (SegFormer) vs.\ foundation (SAM/DINOv3)
...
\begin{enumerate}
  ...
  and/or a DINOv3 backbone with a trained segmentation head.
